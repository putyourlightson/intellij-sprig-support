package com.github.putyourlightson.intellijsprigsupport.completion

import com.github.putyourlightson.intellijsprigsupport.Sprig
...
class SprigSwapCompletion : CompletionProvider<CompletionParameters?>() {
    override fun addCompletions(
        ...
        options.map { (key, value) ->
            LookupElementBuilder.create(key).withIcon(Sprig.ICON).withTypeText(value)
